...
jQuery(document).ready(function($) {
	var spanNum = Drupal.settings.spanNum;
	var sidebar = $('#sidebar');
	...
	function mainContentReflow(){
		if(sidebar.parent().css('display') == 'none'){
			insideHeader.removeClass(spanNum).addClass('span12');
			mainContent.removeClass(spanNum).addClass('span11');
		}
		else{
			insideHeader.removeClass('span12').addClass(spanNum);
			mainContent.removeClass('span11').addClass(spanNum);
		}
	}
	/**
	 * LayerSlider 3
