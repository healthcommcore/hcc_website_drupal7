			...
			layer.children().each(function(){
				...
				if( !sl.hasClass('ls-bg') ){
					...
					if( ol.indexOf('%') != -1 ){
						...
						sl.css({
							// DR change 5-6-14
							// This override is for HCC rotator image description styling
							//left : slC + parseInt(ol) * ls.g.ratio
						});
					}	

					// DR change 5-6-14
					// Add special class for rotator image description
					if (sl.context.nodeName == 'DIV') {
						sl.addClass('rotator-overlay hidden-phone');
						sl.css({width: '250px', height: $(this).parent().height(), left: '72%', padding: '18px 28px'});
					}
